...
class ProfessorsControllerTest < ActionController::TestCase
  ...
  test "should create professor" do
    assert_difference('Professor.count') do
      post :create, professor: { apelido: @professor.apelido, disciplina: @professor.disciplina, email: @professor.email, nome: @professor.nome }
    end
  ...
  test "should update professor" do
    patch :update, id: @professor, professor: { apelido: @professor.apelido, disciplina: @professor.disciplina, email: @professor.email, nome: @professor.nome }
    assert_redirected_to professor_path(assigns(:professor))
  end
